...
const pages = [
  ...
  },
  {
    ...
    extra: '<section class="service-block" aria-labelledby="document-sample-heading"><h2 id="document-sample-heading">See what a useful record contains.</h2><p>A record should separate what was observed, what needs checking, and who is responsible for the next action. Our fictional example shows that distinction.</p><a class="arrow-link" href="samples.html#deliverable-example">View the documentation sample &rarr;</a></section>',
    faqs: [
