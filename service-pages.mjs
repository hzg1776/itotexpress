...
const pages = [
  ...
  },
  {
    ...
    title: 'Industrial Network Infrastructure & Troubleshooting | IT/OT Express LLC',
    description: 'Industrial network planning, installation, and troubleshooting: switches, copper and fiber connections, cabinets, redundant paths, and documentation. Based in North Carolina.',
    heading: 'Industrial networks, from the machine to the plant backbone.',
    introduction: 'We plan, install, troubleshoot, and document the networks that connect production equipment and plant systems. The work covers industrial switches, copper and fiber connections, and the cabinets and cable organization that keep those connections accessible and maintainable.',
    takeaway: 'A network plan, installation, or investigation with clear drawings, recorded checks, and a handover your IT and maintenance teams can use.',
    start: ['A new line, an upgrade, or a connection that keeps failing', 'Tell us what you need to connect or change, how the site operates, and what is causing trouble. We review the existing network and agree on the work needed, from one equipment connection to links between production areas.'],
    interest: 'industrial',
    cta: 'Discuss your plant network',
    sectionHeading: 'The infrastructure behind your plant network',
    sectionIntro: 'Operational technology (OT) monitors and controls physical equipment. Its network needs to suit the distances, conditions, and maintenance demands of your plant, as well as the devices it connects.',
    topics: [
      ['Site Assessments and Network Planning', 'Map the existing connections and plan for equipment additions or upgrades. Review distances, traffic needs, spare capacity, and exposure to heat, dust, moisture, vibration, and electrical noise.'],
      ['Industrial Switches and Equipment Connections', 'Install and configure network equipment connecting machine controllers (PLCs), operator screens (HMIs), and plant systems. Plan how production areas connect to the wider plant network.'],
      ['Copper and Fiber Connections', 'Review cable types, routes, patching, and connections between equipment and production areas. Match the network links to the distance, environment, and equipment requirements.'],
      ['Network Cabinets and Cable Organization', 'Plan equipment placement, patch panels, cable routing, and labels. Keep connections identifiable and accessible, with room for maintenance and planned expansion.'],
      ['Traffic Separation and Redundant Paths', 'Configure network traffic separation and support Parallel Redundancy Protocol (PRP) networks with two communication paths. Agree on the required connections and failure checks with your team.'],
      ['Troubleshooting, Testing, and Handover', 'Investigate unreliable connections and check the agreed changes. Record the results and update network drawings, equipment lists, and connection records so your team can support the installation.']
    ],
    ...
    outputHeading: 'A handover your team can use',
    output: 'An assessment gives you findings and recommended next steps. For installation or upgrades, the agreed handover can include drawings of the installed connections, cabinet layouts, cable and port records, and test results. We identify what was verified, what changed, and anything still needing attention.',
    ...
    faqs: [
      ['Can you work on an existing plant network?', 'Yes. We start with the installed equipment, available records, and the change you need. The plan identifies what can remain, what needs updating, and how the work fits around production and your existing support teams.'],
      ['What is a plant network backbone?', 'It is the main set of network links connecting production areas and plant systems. Individual machines connect through local switches, which connect back to this wider network.'],
  ...
  },
  {
    ...
    description: 'Network diagrams, cabinet layouts, cable and port records, equipment lists, and handover documents for office and industrial networks in North Carolina.',
    ...
    topics: [
      ['Network Diagrams and Cabinet Layouts', 'Logical diagrams explain how the network is organized. Physical drawings show equipment locations, cabinet layouts, and the copper or fiber connections between them.'],
      ['Cable, Port, and Equipment Records', 'Match cable labels to their endpoints, patch-panel positions, and switch ports. Keep those records alongside the equipment list so a technician can trace a connection and check what is installed.'],
    ...
    output: 'You receive the agreed drawings and records with revision dates, verification notes, and any unresolved gaps. For installation work, the handover can also include recorded checks and drawings updated to reflect the installed connections. We agree on editable file formats and review the documents with the people who will maintain them.',
    extra: `<section class="service-block" id="network-topology" tabindex="-1" aria-labelledby="network-topology-heading">
          <p class="eyebrow">Network documentation example</p>
          <h2 id="network-topology-heading">From network connections to a useful record.</h2>
          <p>This two-sheet example shows how a logical IT/OT network drawing can connect device identifiers, numbered links, and an equipment register. It follows the <a href="index.html#purdue-model">Purdue Model</a>, from business systems through an industrial DMZ to plant operations and control devices.</p>
          <p><strong>Reference example — not an as-built network.</strong> It illustrates a documentation format, not a customer installation. IP addresses, VLANs, physical ports, equipment models, and locations are marked TBD for site verification.</p>
          <figure class="itot-architecture">
            <a class="itot-architecture-image" href="assets/network-topology-sheet-1.webp" aria-label="Open the full-size logical network topology">
              <img src="assets/network-topology-sheet-1.webp" width="2040" height="1320" loading="lazy" decoding="async" alt="Sheet 1: a reference IT/OT logical topology with 24 identified devices and 23 numbered connections. Business systems connect through two industrial DMZ firewalls to plant operations and two separated control cells.">
            </a>
            <figcaption><span>Sheet 1 — Logical topology. Device IDs and numbered connections make each part of the drawing traceable.</span><a href="assets/network-topology-sheet-1.webp">Open sheet 1 full size <span aria-hidden="true">↗</span></a></figcaption>
          </figure>
          <details class="topology-register">
            <summary>View sheet 2: device and connection register</summary>
            <figure class="itot-architecture">
              <a class="itot-architecture-image" href="assets/network-topology-sheet-2.webp" aria-label="Open the full-size network documentation register">
                <img src="assets/network-topology-sheet-2.webp" width="2040" height="1320" loading="lazy" decoding="async" alt="Sheet 2: a register matching the 24 device IDs to their roles and Purdue levels, with connection groups and site survey fields to verify before issuing an as-built drawing.">
              </a>
              <figcaption><span>Sheet 2 — Documentation register. Equipment details, connection records, and survey notes show what still needs checking.</span><a href="assets/network-topology-sheet-2.webp">Open sheet 2 full size <span aria-hidden="true">↗</span></a></figcaption>
            </figure>
          </details>
          <nav class="purdue-downloads" aria-label="Download the network topology documentation">
            <a class="button" href="https://github.com/hzg1776/itotexpress/raw/refs/heads/main/resources/network-topology/ITOT_Network_Topology_11x17.pdf">Download two-sheet PDF <span aria-hidden="true">↗</span></a>
            <a class="button button-secondary" href="https://github.com/hzg1776/itotexpress/raw/refs/heads/main/resources/network-topology/ITOT_Network_Topology_11x17.vsdx">Download editable Visio <span aria-hidden="true">↗</span></a>
          </nav>
          <p class="purdue-reference-note">Both files contain two 11 × 17 inch landscape sheets. The Visio file includes editable devices, labels, and connectors. Free downloads are hosted on GitHub.</p>
          <p>For a written example of observations and follow-up actions, <a href="samples.html#deliverable-example">view the documentation sample</a>.</p>
        </section>`,
    faqs: [
